...
{
    private final double consumo,priceIPVA;//consumo=a quantidade em litros que o automovel gasta para se mover um "espaco",priceIPVA=o preco do IPVA do automovel
	...
	IPVA=(rand.nextInt(101)%2==0?true:false);//sorte um numero de 0 a 100, caso esse numero seja par, entao o IPVA esta pago, caso o contrario ele nao esta
	combustivel=3.5;
    }
    public boolean Mover()
    {
	if(IPVA&&combustivel>super.GetSpeed()*consumo&&super.Mover())//caso o carro esteja com o IPVA pago e tenha combustivel suficiente, seu movimento depende da calibragem

public abstract class Veiculo
{
    ...
    private final int nrod,mov,id;//nrod=numero de rodas,mov=velocidade do veiculo em quantidade de "espacos" que ele percorre num turno,id=a identificacao do veiculo
	...
	for(int i=0;i<rodas.length;i++)
	    {
		data+=", roda "+(i+1)+": ";
		data+=rodas[i].GetCalibragem()?"F":"E";//caso a calibragem da roda seja igual a true, entao esfre "F" Full, caso contrario "E" Empty 
	    }
